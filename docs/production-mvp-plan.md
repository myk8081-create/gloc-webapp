...
7. 대리점은 내 재고와 타대리점 재고를 분리 조회하고, 내 대리점 재고 수정과 발주는 본인 대리점 코드로만 등록합니다.
8. 관리자는 웹에서 전체 대리점 재고, 제품등록 정보, 전체 발주 상태를 관리합니다.

## 권한

- `admin`: 전체 재고 조회/수정, 제품 등록/수정/삭제, 전체 발주 조회, 발주 상태 변경, 대리점 계정 생성/초기화/중지/삭제, QR/안내문 생성
- `dealer`: 내 대리점 재고 조회/수정, 타대리점 재고 조회, 본인 발주 등록/조회, 최초 로그인 비밀번호 변경
